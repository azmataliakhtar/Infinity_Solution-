<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ShoppingCart.aspx.vb" Inherits="INF.Web.Ajax.ShoppingCart" %>
                        ...
                        <asp:Repeater runat="server" ID="rptCartItems" OnItemDataBound="rptCartItems_ItemDataBound">
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="ttlPrice"><%# Eval("UnitPrice")%></td>
                                    <td class="delPrd">
                                ...
                                <asp:Repeater runat="server" ID="rptSubCartItems">
                                    ...
                                    <ItemTemplate>                                   
                                         ...
                                         <tr class="dealRowItem">
                                        
                                            <td colspan="3" class="dealThreeCols"><%# Eval("Name")%></td>
