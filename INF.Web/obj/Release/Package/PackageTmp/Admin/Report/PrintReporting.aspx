<%@ Page Language="VB" AutoEventWireup="false" Inherits="INF.Web.Admin_Report_PrintReporting" Codebehind="PrintReporting.aspx.vb" %>
...
<body>
    ...
    <ajaxToolkit:ToolkitScriptManager runat="server" ID="ToolkitScriptManager1" />
        <div style="width: 100%;display:block;" id="rpt-container">
             <rsweb:ReportViewer ID="BasicMonthlyReportViewer" AsyncRendering="false"  ShowToolBar="false"
                ...
                <LocalReport ReportPath="Admin\rdlc\OrdersMonthly.rdlc">
