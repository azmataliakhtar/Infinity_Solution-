<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/ReportingMaster.master" AutoEventWireup="true" Inherits="INF.Web.Admin_BasicReport" CodeBehind="BasicReport.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitlePlaceHolder" runat="Server">
    <%=EPATheme.Current.Themes.WebsiteName%>-Basic Report
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="row">
        <h1 class="page-header page-title">Basic Report</h1>
    </div>
    <div class="row">
    ...
    <div id="rpt-container" class="row">
        <rsweb:ReportViewer ID="BasicMonthlyReportViewer" AsyncRendering="false"
            runat="server" Width="100%" Font-Names="Arial" Font-Size="8pt" InteractiveDeviceInfos="(Collection)"
            WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%">
            <LocalReport ReportPath="Admin\rdlc\OrdersMonthly.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
