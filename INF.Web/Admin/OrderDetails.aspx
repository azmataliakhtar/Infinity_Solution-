<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/DashboardMaster.master" CodeBehind="OrderDetails.aspx.vb" Inherits="INF.Web.OrderDetails" %>
                            ...
                            <asp:Repeater runat="server" ID="OrderDetailsRepeater">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%#Eval("ItemName")%></td>
                                        <td style="width: 80px; text-align: right;"><%#Eval("UnitPrice")%></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
