<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="false" Inherits="INF.Web.Admin.UserEdit" Codebehind="UserEdit.aspx.vb" %>
        ...
        <div style="width: 610px; float: left;">
            <table style="width: 600px" cellpadding="0" cellspacing="0" border="0" class="customer-detail-table">
                ...
                <tr>
                    <th>Is Actived:</th>
                    <td>
                        <asp:TextBox runat="server" ID="IsActivedTextBox" Width="90%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                </tr>
                <tr>
                    <th>Role:</th>
                    <td>
                        <asp:TextBox runat="server" ID="UserRoleTextBox" Width="90%"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
