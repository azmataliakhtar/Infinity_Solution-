...
Namespace Ajax
    ...
    Partial Class IncreaseQuantity
        ...
        Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
            ...
            Try
                If Not Page.IsPostBack Then
                    Dim cartId As String = WebUtil.GetParameterValueAsString(Page.Request, "CartID")
                    If String.IsNullOrWhiteSpace(cartId) Then Return

                    Dim basket As BxShoppingCart = BxShoppingCart.GetShoppingCart()
                    basket.AddItem(cartId)
