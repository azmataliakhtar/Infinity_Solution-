<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SmallShoppingCart.aspx.vb" Inherits="INF.Web.Ajax.SmallShoppingCart" %>
    ...
    <asp:multiview runat="server" id="mvShoppingCart">
         ...
         <asp:View runat="server" ID="vEmptyCart">
            ...
            <asp:View runat="server" ID="vNonEmptyCart">
                        ...
                        <asp:Repeater runat="server" ID="rptCartItems" OnItemDataBound="rptCartItems_ItemDataBound">
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="delPrd">
                                         <a href="<%# "javascript:RemoveMenuItemFromShopCartWithDeals('" + Eval("CartID") + "');"%>">
               ...
               <p></p>
              <%--<asp:HiddenField  ID="hdTotalPrice" runat="server" />
              <asp:HiddenField  ID="hdRemainingTime" runat="server" Value="0" />--%>
