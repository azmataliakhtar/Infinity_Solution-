...
namespace INF.Database.Metadata
{
    ...
    {
        private readonly Dictionary<Type, TableInfo> _typeToTableInfo = new Dictionary<Type, TableInfo>();
        ...
        {
            if (!_typeToTableInfo.ContainsKey(entityType))
            {
                return null;
            }

            return _typeToTableInfo[entityType];
        }
        ...
        public void BuildMetaDataFor(Assembly assembly)
        {
            ...
            foreach (KeyValuePair<Type, TableInfo> pair in _typeToTableInfo)
            {
        ...
        private void BuildMapOfEntityTypesWithTheirTableInfo(Assembly assembly)
        {
            foreach (var type in assembly.GetTypes())
            {
                ...
                if (typeAttributes.Length > 0)
                {
                    ...
                    _typeToTableInfo.Add(type, tableInfo);
                }
            }
        }
