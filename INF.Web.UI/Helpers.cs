...
namespace INF.Web.UI
{
    public static class Helpers
    {
        ...
        public static void SetInputControlsHighlight(Control container, string className, bool onlyTextBoxes)
        {
            ...
            //        var backClassName = wctl.CssClass;
            //        //wctl.Attributes.Add("onfocus", string.Format("this.className = '{0} {1}';",backClassName, className));
            //        //wctl.Attributes.Add("onblur", string.Format("this.className = '{0} {1}';", backClassName, "normal-input"));
            //        //wctl.CssClass = backClassName + " " + "normal-input";
            //    }
            //    else
            //    {
